          ...
          return Obx(
            () => GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(color: controller.currentDay.value == index ? Colors.white : Colors.white12, borderRadius: BorderRadius.circular(15)),
                child: Column(
                  children: [
                    SizedBox(
                      height: 50,
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        color: controller.currentDay.value == index ? Colors.purple : Colors.white,
                        fontSize: 30,
                        height: 0,
