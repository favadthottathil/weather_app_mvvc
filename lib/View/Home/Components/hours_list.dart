                ...
                () => Card(
                  ...
                  child: Obx(
                    () => Container(
                      ...
                      decoration: BoxDecoration(color: controller.compareIndex(index) ? Colors.blue : Colors.white70, borderRadius: BorderRadius.circular(50)),
                      child: Column(
